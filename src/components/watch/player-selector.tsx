    ...
    if (mediaType === 'movie') {
      baseOptions.push(
        ...
        },
        {
          id: 'vidify-hindi',
          name: 'Vidify',
          url: buildUrl(`https://player.vidify.top/embed/movie/${mediaId}?server=hindi&autoplay=true&pip=true&logourl=${siteConfig.url}/logo.png&download=true`),
          description: 'Multi-language supported',
          language: 'Hindi',
          icon: Icons.play,
          quality: 'HD',
    ...
    if (mediaType === 'tv') {
      baseOptions.push(
        ...
        },
        {
          ...
          name: 'Vidify',
          url: buildUrl(
            `https://player.vidify.top/embed/tv/${mediaId}/${season || 1}/${episode || 1}?server=hindi&autoplay=true&pip=true&logourl=${siteConfig.url}/logo.png&download=true`,
          ),
