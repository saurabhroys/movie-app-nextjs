...
export const ShowCard = ({ show, pathname }: ShowCardProps) => {
  ...
  return (
    <div
      className="group relative aspect-video transition-all duration-10 hover:z-50 hover:scale-125"
      ...
      {isHovered && (
        <div className="relative bg-black/50">
          <div className="pointer-events-auto absolute z-50 w-full">
            <div className="overflow-hidden rounded-lg border border-neutral-600 bg-black shadow-2xl">
              <div className="relative aspect-video">
                ...
                <div className="absolute inset-0 -bottom-1 z-10 bg-linear-to-t from-black via-black/20 to-transparent"></div>
              ...
              <a className="bg-black px-2" href="">
                <div className="w-full px-2">
                  ...
                  <div className="mb-1 flex items-center gap-1 text-xs text-neutral-300">
